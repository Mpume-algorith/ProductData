...
namespace ProductData.Controllers
{
    public class ProductController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,BrandID,Name,Price,Quantity")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,BrandID,Name,Price,Quantity")] Product product)
        {
            if (ModelState.IsValid)
            {
